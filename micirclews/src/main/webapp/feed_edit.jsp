...
<div class='marg'>
    ...
    <c:choose>
        ...
        <c:when test="${not empty sessionScope.errorMain}">
            <h3 id="error-message">${sessionScope.errorMain}</h3>
            <script>
        ...
        <c:otherwise>
            ...
            <form class="col-lg-6 col-lg-offset-3 needs-validation" action="<%= blobstoreService.createUploadUrl("/feed/edit") %>" method="post" enctype="multipart/form-data" novalidate>

                <h1 align="center">Edit Feed</h1>
                <br/>

                <div class="form-row">
                    <input type="hidden" class="form-control input" id="feed-id" name="feed-id" value="${sessionScope.feedId}" />
                </div>
                ...
                <div class="form-row">
                    ...
                    <input type="text" value="${sessionScope.title}" class="form-control input" id="title" name="title" maxlength="100" />
                ...
                <div class="form-row">
                    ...
                    <textarea class="form-control input" id="description" name="description" rows="5" maxlength="999" >${sessionScope.description}</textarea>
                ...
                <div align="center"><input type="submit" class="btn btn-primary" value="EDIT"/></div>
            </form>
        </c:otherwise>
    </c:choose>
